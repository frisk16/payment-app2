...
const Month1to3PaymentsPage: FC<Props> = memo((props) => {
    const { auth } = props;
    
    const year = new Date().getFullYear();
    const month = route().params.month && route().params.month.match(/^(1|2|3)$/) ? Number(route().params.month) : 1;
...
export default Month1to3PaymentsPage;